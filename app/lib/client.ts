...
export namespace fuck {
    ...
    export class ServiceClient {
        ...
        public async chatAgent(method: "POST", body?: BodyInit, options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/agents/chat`, body, options)
        }
...
export namespace openai {
    ...
    export class ServiceClient {
        ...
        public async getCommunicationCoach(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/communication-coach`)
        ...
        public async getDataAnalyst(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/data-analyst`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getFinancialAdvisor(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/financial-advisor`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getHRConsultant(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/hr-consultant`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getInnovationConsultant(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/innovation-consultant`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getLegalAdvisor(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/legal-advisor`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getMarketingAdvisor(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/marketing-advisor`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getProductivityCoach(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/productivity-coach`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getProjectManager(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/project-manager`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getSupervisor(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/supervisor`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getTechAdvisor(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/tech-advisor`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async getWellnessCoach(): Promise<AgentEphemeral> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/wellness-coach`)
            return await resp.json() as AgentEphemeral
        }
        ...
        public async openaiStream(method: "POST", body?: BodyInit, options?: CallParameters): Promise<globalThis.Response> {
            return this.baseClient.callAPI(method, `/api/stream-chat`, body, options)
        }
    }
}
