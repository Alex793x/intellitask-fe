...
class $ {
  ...
  async getAuthData() {
    ...
    if (a) {
      const n = {};
      return n.headers = o({ cookie: a.cookie }), n;
    }
  }
  ...
  async callAPI(a, n, e, t) {
    ...
    const c = { ...this.requestInit, ...v, method: a, body: e != null ? e : null };
...
function N(s) {
  return s != null && q(s.code) && typeof s.message == "string" && (s.details === void 0 || s.details === null || typeof s.details == "object");
}
function q(s) {
...
export { H, J, L };
//# sourceMappingURL=client-DM3TFEX8.mjs.map
