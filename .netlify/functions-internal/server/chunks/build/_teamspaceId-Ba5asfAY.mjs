...
import { af as Ta, P as Ps, t as ta, _ as _$1, m as me, j as v, v as ve, u as ue, h as la, p as Ee, O as Oe, q as _e, n as ne, T as Te, c as ce, a3 as ge, R as Rs, a1 as te, e as ee, a2 as Nt, a0 as dt } from '../nitro/nitro.mjs';
...
function X({ teamspaceId: p$1, children: o }) {
  const N = useNavigate(), [d$1, u$1] = useState(false), c = useSetAtom(Ps), v = useSetAtom(Rs), [i, n] = useState({ name: "", description: "", context: "", isPrivate: false }), m = (r) => {
...
const xs = function() {
  var _a, _b;
  const { teamspaceId: o } = Ta.useParams(), [N, d] = useAtom(Ps), [u, c] = useState(false), [v$1, i] = useState(true), { data: n, isPending: m } = ta(), [b, w] = useState("");
  useEffect(() => {
...
//# sourceMappingURL=_teamspaceId-Ba5asfAY.mjs.map
