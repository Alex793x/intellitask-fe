...
import { ag as Sa, P as Ps, G as Ge, _, m as me, v as ve, u as ue, n as ne, c as ce, a9 as Ue, aa as Se, ab as Fe, j as v, h as la, p as Ee$1, O as Oe, q as _e, T as Te, a3 as ge, a1 as te, e as ee, a2 as Nt, ah as Ss, a0 as dt } from '../nitro/nitro.mjs';
...
import { N as Ne, p as pe, x as xe, y as ye, l as le } from './collapsible-Dxb8_8QV.mjs';
import { toast } from 'sonner';
import { b, f, p, u, y, g, h, v as v$1 } from './dialog-Dg-RNf6E.mjs';
import { d } from './checkbox-B_V_JN0z.mjs';
import { cva } from 'class-variance-authority';
import { useFileUpload, FileUpload } from '@ark-ui/react';
import { i } from './avatar-sfP8wNYv.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const je = ({ teamspaceId: l = null, projectId: g = null, chatroomId: u$1 = null, organizationId: v$1, receiverIds: A = [], onUploadComplete: P, compact: b$1 = false, files: C = [], className: j = "" }) => {
  ...
  var _a, _b, _c, _d, _e2;
  const { projectId: g$1 } = Sa.useParams(), [u$1, v$1] = useState(false), [A, P] = useState(true), [b$1, C] = useState(""), [j, M] = useState(""), [k, D] = useState(false), [E, N] = useState(false), [i, w] = useState(null), [m, F] = useState(false), [S, T] = useAtom(Ps), R = useSetAtom(Ge), $ = Sa.useRouteContext(), [O] = useState($.userId), s = S.flatMap((a) => a.projects || []).find((a) => a.id === g$1), r = S.find((a) => a.id === (s == null ? void 0 : s.teamspaceId));
  useEffect(() => {
...
//# sourceMappingURL=_projectId-oGNOZHEi.mjs.map
