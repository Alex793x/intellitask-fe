...
const u = F.forwardRef(({ className: e, ...t }, s) => jsx(a.Title, { ref: s, className: v$1("text-lg font-semibold leading-none tracking-tight", e), ...t }));
u.displayName = a.Title.displayName;
const y = F.forwardRef(({ className: e, ...t }, s) => jsx(a.Description, { ref: s, className: v$1("text-sm text-muted-foreground", e), ...t }));
y.displayName = a.Description.displayName;

export { b, f, g, h, p, u, v, y };
//# sourceMappingURL=dialog-C9He1Myg.mjs.map
