...
import { ag as Sa, A as As, G as Ge, _, m as me, v as ve, u as ue, n as ne, c as ce, a9 as Ue, aa as Se, ab as Fe, j as v, h as la, p as Ee$1, O as Oe, q as _e, T as Te, a3 as ge, a1 as te, e as ee, a2 as Nt, ah as Ss, a0 as dt } from '../nitro/nitro.mjs';
...
import { N as Ne, p as pe, x as xe, y as ye, l as le } from './collapsible-CLMqXrmx.mjs';
import { toast } from 'sonner';
import { b, f, p, u, y, g, h, v as v$1 } from './dialog-OikZOCOr.mjs';
import { d } from './checkbox-Ct6Awgg0.mjs';
import { cva } from 'class-variance-authority';
import { useFileUpload, FileUpload } from '@ark-ui/react';
import { i } from './avatar-AsaixftK.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
function it({ project: l, onProjectUpdated: g$1, trigger: u$1, userId: v }) {
  const A = useNavigate(), P = useSetAtom(As), [b$1, C] = useState(false), [j, M] = useState(false), [k, D] = useState(false), [E, N] = useState(false), [i, w] = useState(""), [m, F] = useState({ name: "", description: "", isPrivate: false }), [S, T] = useState(true);
  useEffect(() => {
    var _a;
    if (b$1) {
...
const je = ({ teamspaceId: l = null, projectId: g = null, chatroomId: u$1 = null, organizationId: v$1, receiverIds: A = [], onUploadComplete: P, compact: b$1 = false, files: C = [], className: j = "" }) => {
  ...
  if (!s) return jsxs("div", { className: "flex-1 flex flex-col items-center justify-center p-8 text-center", children: [jsx("h2", { className: "text-2xl font-bold mb-4", children: "Project not found" }), jsx("p", { className: "text-muted-foreground mb-6", children: "The project you're looking for doesn't exist or you don't have access to it." }), r ? jsx(_, { variant: "outline", asChild: true, children: jsx(Link, { to: "/teamspace/$teamspaceId", params: { teamspaceId: r.id }, children: "Back to Teamspace" }) }) : jsx(_, { variant: "outline", asChild: true, children: jsx(Link, { to: "/chat", children: "Go to Chat" }) })] });
  const f$1 = async (a = "") => {
    var _a2;
    if (u$1) return;
    v$1(true);
    const c = Ss({ currentUserId: O, project: s, teamspace: r });
    try {
      const { data: o } = await ge().chatrooms.createChatroom({ chatroomCreatorId: O, chatroomMembers: c, isPrivate: false, projectId: s.id, name: a.trim() || "New Chat Conversation", teamIds: [], type: "PROJECT_CHATROOM" });
    ...
    if (!(!b$1.trim() || u$1)) try {
      v$1(true);
      const a = Ss({ currentUserId: O, project: s, teamspace: r }), { data: c } = await ge().chatrooms.createChatroom({ chatroomCreatorId: O, chatroomMembers: a, isPrivate: false, projectId: s.id, name: "New Chat Conversation", teamIds: [], type: "PROJECT_CHATROOM" });
  ...
  }, autoFocus: true }), jsx(_, { size: "sm", onClick: () => f$1(j), disabled: u$1, className: "bg-emerald-600 hover:bg-emerald-700 text-white hover:cursor-pointer", children: "Create" }), jsx(_, { size: "sm", variant: "ghost", onClick: () => {
    N(false), M("");
  }, className: "hover:cursor-pointer", children: "Cancel" })] }) : jsxs(_, { size: "sm", onClick: () => N(true), disabled: u$1, className: "bg-emerald-600 hover:bg-emerald-700 text-white hover:cursor-pointer", children: [jsx(MessageSquarePlus, { className: "h-4 w-4 mr-2" }), " New Chat"] })] }), s.chatrooms && s.chatrooms.length > 0 ? jsx("div", { className: "space-y-3", children: s.chatrooms.map((a) => {
    var _a2;
  ...
  } })] }) })] })] })] })] }), jsx(b, { open: !!i, onOpenChange: (a) => !a && w(null), children: jsxs(f, { children: [jsxs(p, { children: [jsxs(u, { className: "flex items-center", children: [jsx(AlertCircle, { className: "h-5 w-5 text-red-500 mr-2" }), "Delete File"] }), jsxs(y, { children: ["Are you sure you want to delete ", jsx("span", { className: "font-medium", children: i == null ? void 0 : i.fileName }), "? This action cannot be undone."] })] }), jsxs(g, { children: [jsx(_, { variant: "outline", onClick: () => w(null), disabled: m, children: "Cancel" }), jsx(_, { variant: "destructive", onClick: () => i && I(i), className: "bg-red-600 hover:bg-red-700 text-white", disabled: m, children: m ? "Deleting..." : "Delete" })] })] }) })] });
};

export { tr as component };
//# sourceMappingURL=_projectId-DepA6nKM.mjs.map
