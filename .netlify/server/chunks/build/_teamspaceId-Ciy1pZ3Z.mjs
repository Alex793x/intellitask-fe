...
import { af as Ta, A as As, t as ta, _ as _$1, m as me, j as v, v as ve, u as ue, h as la, p as Ee, O as Oe, q as _e, n as ne, T as Te, c as ce, a3 as ge, R as Rs, a1 as te, e as ee, a2 as Nt, a0 as dt } from '../nitro/nitro.mjs';
...
function X({ teamspaceId: p$1, children: o }) {
  const N = useNavigate(), [d$1, u$1] = useState(false), c = useSetAtom(As), v = useSetAtom(Rs), [i, n] = useState({ name: "", description: "", context: "", isPrivate: false }), m = (r) => {
    n({ ...i, [r.target.name]: r.target.value });
  }, b$1 = (r) => {
    n({ ...i, isPrivate: r });
  };
  return jsxs(b, { children: [jsx(h, { asChild: true, children: o || jsxs(_$1, { size: "sm", className: "bg-indigo-600 hover:bg-indigo-700 text-white hover:cursor-pointer", children: [jsx(FolderPlus, { className: "h-4 w-4 mr-2" }), " New Project"] }) }), jsx(f, { className: "sm:max-w-[500px]", children: jsxs("form", { onSubmit: async (r) => {
